...
void *vector_tablerom[] __attribute__((section(".irq"))) = {
    // Stack and Reset Handler

    &_initsp,           /* Top of stack */
...
void *vector_table[] __attribute__((aligned(512))) = {
    ...
    MemManage_Handler,  /* Memory manage,ent */
    ...
    PVD_PVM_IRQHa0ndler,    /*   */
    RTC_TAMP_STAMP_IRQHandler,  /* Time Stamp */
    ...
    DMA1_CH2_IRQHandler,    /* DMA1 Channel 2 */
    DMA1_CH3_IRQHandler,    /* DMA1 Channel 3 */
    DMA1_CH4_IRQHandler,    /* DMA1 Channel 4 */
    DMA1_CH5_IRQHandler,    /* DMA1 Channel 5 */
    DMA1_CH6_IRQHandler,    /* DMA1 Channel 6 */
    DMA1_CH7_IRQHandler,    /* DMA1 Channel 7 */
    ADC1_2_IRQHandler,      /* ADC1 and ADC2 global interrupt */
    CAN1_TX_IRQHandler,     /* CAN1_TX interrupt */
    CAN1_RX0_IRQHandler,    /* CAN1_RX0 interrupt */
    ...
    I2C2_ER_IRQHandler,     /* I2C2 event interrupt */
